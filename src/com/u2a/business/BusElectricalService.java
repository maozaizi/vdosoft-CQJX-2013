...
public class BusElectricalService extends Service {
	 ...
	 */
	public IMap getBusElectricalList(IMap in) {
		// 设置结果集
	 ...
	 */
	public IMap<String, Object> getbusWorkAndBusElectricalDetails(IMap<String, Object> in) {
		IMap<String, Object> result = new DataMap<String, Object>();// 输出map
		IMap selectMap = BeanFactory.getClassBean("com.BusElectrical");
		selectMap.put("id", in.get("id"));
		//电修信息
		IMap busElectricalMap = db.get(selectMap);
		//施工卡信息
		IMap busWorkCardMap =BeanFactory.getClassBean("com.BusWorkCard");
		busWorkCardMap.put("busId",busElectricalMap.get("id"));
		busWorkCardMap.put("busName","com.BusElectrical");
		busWorkCardMap.put("isValid", 1);
		//进修单基本信息
		IMap busInrepairInfoMap =BeanFactory.getClassBean("com.BusInrepairInfo");
		busInrepairInfoMap.put("id",busElectricalMap.get("inrepairId"));
		...
		String [] orgIds = busElectricalMap.get("orgId").toString().replace(".",",").split(",");
		//厂区
		...
		baseOrganization.put("orgCode", busElectricalMap.get("orgId"));
		...
		result.put("busElectricalMap",busElectricalMap );
	...
	public IMap saveBusWorkCard(IMap in){
		...
		String remark="派工人员："+userMap.get("name")+"在"+dftow.format(date)+"添加了施工卡信息。";
		LogBean logb=new LogBean(userMap,in.get("busId").toString(), "com.BusElectrical","",remark, "0");
		LogRecordsService.saveOperationLog(logb,db);
		IMap selectMap = BeanFactory.getClassBean("com.BusElectrical");
		selectMap.put("id", in.get("busId"));
		//进修单信息
		IMap busElectricalMap = db.get(selectMap);
		busElectricalMap.put("dispatchingRemark", in.get("dispatchingRemark"));
		//将开工时间添加到主表中
		busElectricalMap.put("startDate", busWorkCardMap.get("startDate"));
		db.update(busElectricalMap);
		// 发起工作流
	 ...
	 * @date Jul 17, 2013 5:39:18 PM
	 */
	public IMap<String, Object> toBusElectricalDetailsPage(IMap<String, Object> in) {
		IMap<String, Object> result = new DataMap<String, Object>();// 输出map
		IMap selectMap = BeanFactory.getClassBean("com.BusElectrical");
		selectMap.put("id",in.get("id"));
		...
		//业务表基本信息
		IMap busElectricalMap = db.get(selectMap);
		if(busElectricalMap==null){
			IMap selectMaps = BeanFactory.getClassBean("com.BusElectrical");
			selectMaps.put("inrepairId",in.get("id"));
			selectMaps.put("isValid", 1);
			busElectricalMap=db.get(selectMaps);
		}
		//进修单信息
		IMap busInrepairInfo =BeanFactory.getClassBean("com.BusInrepairInfo");
		busInrepairInfo.put("id", busElectricalMap.get("inrepairId"));
		IMap busInrepairInfoMap = db.get(busInrepairInfo);
		IMap condition = new DataMap();
		//业务表
		condition.put("busIdOne",busElectricalMap.get("id"));
		condition.put("busNameOne","com.BusElectrical");
		//进修单
		...
		con.put("busId", busElectricalMap.get("id"));
		con.put("busName","com.BusElectrical");
		...
		busTestRecordMap.put("busId",busElectricalMap.get("id"));
		busTestRecordMap.put("busName","com.BusElectrical");
		OrderBean orderBean = new OrderBean();
	 ...
	 */
	public IMap<String, Object> getBusElectricalDetails(IMap<String, Object> in) {
		IMap<String, Object> result = new DataMap<String, Object>();// 输出map
		IMap selectMap = BeanFactory.getClassBean("com.BusElectrical");
		selectMap.put("id", in.get("id"));
		//进修单信息
		IMap busElectricalMap = db.get(selectMap);
		result.put("busElectricalMap",busElectricalMap );
//		result.put("equipmentInfoMap", equipmentMap);
		//工作流信息
		result.put("stepId", in.get("stepId"));
		result.put("nodeId", in.get("nodeId"));
		result.put("instanceId", in.get("instanceId"));
	...
	public IMap<String, Object> toMaterialPlan(IMap<String, Object> in) {
		...
		busPlanInfoMap.put("busId",busElectricalMap.get("id"));
		...
		condition.put("busNameOne","com.BusElectrical");
		//进修单
		condition.put("busIdTow",busElectricalMap.get("inrepairId"));
		condition.put("busNameTow","com.BusInrepairInfo");
		//审批详情列表
		List<IMap> logRecordsList = db.getList(condition, "getLogRecordsList", "com.logRecords");
		result.put("logRecordsList", logRecordsList);
	...
	public IMap<String, Object> modifyBusMaterialPlan(IMap<String, Object> in) {
		...
		IMap busElectricalMap =BeanFactory.getClassBean("com.BusElectrical");
		busElectricalMap.put("id", busId);
		busElectricalMap = db.get(busElectricalMap);
		//领料申请原因
		busElectricalMap.put("planRemark", planRemark);
		db.update(busElectricalMap);
		// 发起工作流
		IMap wfmap = new DataMap();
		IMap condition = new DataMap();
		...
		if(busMaterialPlanList !=null && busMaterialPlanList.size()>0){
			...
			newBusPlanInfoMap.put("busName", "com.BusElectrical");
			...
			//工卡号
			newBusPlanInfoMap.put("workCard",busElectricalMap.get("workCard"));
			//orgId
...
//			}
	 ...
	 * @date Jul 17, 2013 5:39:18 PM
	 */
	public IMap<String, Object> getBusElectricalAndMaterialPlanDetails(IMap<String, Object> in) {
		IMap<String, Object> result = new DataMap<String, Object>();// 输出map
		IMap selectMap = BeanFactory.getClassBean("com.BusElectrical");
		selectMap.put("id", in.get("id"));
		//业务表基本信息
		...
		logRecordsMap.put("busId",busElectricalMap.get("id"));
		logRecordsMap.put("busName","com.BusElectrical");
		...
		attachmentMap.put("busId",busElectricalMap.get("id"));
		attachmentMap.put("busName","com.BusElectrical");
		...
		public IMap updateleadershipAudit(IMap in){
			IMap result = new DataMap();
			IMap bussMap = (IMap) in.get("busElectrical");
			IMap userMap = (IMap) in.get("userMap");
			String remark="";
			String docId="";
			String str="";
			...
			IMap busElectricalMap = BeanFactory.getClassBean("com.BusElectrical");
			busElectricalMap.put("id",bussMap.get("id"));
			busElectricalMap = db.get(busElectricalMap);
			//当前审批计划
			IMap busPlanInfoMap = BeanFactory.getClassBean("com.BusPlanInfo");
			busPlanInfoMap.put("busId",busElectricalMap.get("id"));
			...
			if(in.get("type").toString().equals("jl")){
			 ...
			 if(attachmentInfoMap.get("docUrl")!=null){
				attachmentInfoMap.put("busId", bussMap.get("id"));
				...
				attachmentInfoMap.put("busName","com.BusElectrical");
				//状态2为审批上传文件
				...
				remark="经理："+userMap.get("name")+"在"+date_str+"审批了物料计划，意见为："+busElectricalMap.get("jlRemark")+"；结果为："+str+"。";
				if("0".equals(bussMap.get("jlResult"))){
					orgId = (String) busElectricalMap.get("orgId");
					postCode="车间材料员";
					spresult = "0";
				...
				if("0".equals(bussMap.get("cqResult"))){
					...
					//}
					/****************************************************2015年6月修改********************************************************
					String orgIds = orgCodes[0]+"."+orgCodes[1]+"."+orgCodes[2];
					IMap condition = new DataMap();
					condition.put("orgCode", orgIds);
					List<IMap> deptList = db.getList(condition, "getMachiningList",null);
					String deptId ="";
					if(!deptList.isEmpty()){
						 deptId = deptList.get(0).get("org_code").toString();
					}
					...
					//业务信息
					IMap selectMap = BeanFactory.getClassBean("com.BusElectrical");
					selectMap.put("id", busElectricalMap.get("id"));
					...
					for(int i=0;i<materialPlanList.size();i++){
						...
						//项目部
						machiningMessage.put("proDept", "电修车间");
						//orgId
				...
				if("0".equals(bussMap.get("zrResult"))){
					...
					addbusworkflow(busPlanInfoMap,busElectricalMap,userMap);
					/**********************************************************************************************************/
				}
				...
				for(int i=0;i<attachmentInfoList.size();i++){
					...
					if(attachmentInfoMap.get("docUrl")!=null&!"".equals(attachmentInfoMap.get("docUrl"))){
						attachmentInfoMap.put("busId",busElectricalMap.get("id"));
						attachmentInfoMap.put("id", HelperApp.getAutoIncrementPKID(HelperApp
			...
			LogBean logb=null;
			if(!docId.equals("")){
			 logb=new LogBean(userMap,busElectricalMap.get("Id").toString(), "com.BusElectrical","",remark,"1",docId);
			}else{
			 logb=new LogBean(userMap,busElectricalMap.get("Id").toString(), "com.BusElectrical","",remark,"1");
			}
			LogRecordsService.saveOperationLog(logb,db);
			//工作流信息
			IMap wfmap = new DataMap();
		...
		public IMap getBusMaterialPlanList(IMap in){
			...
			//业务信息
			selectMap = db.get(selectMap);
			result.put("busElectricalMap",selectMap);
			//进修单基本信息
			IMap busInrepairInfoMap =BeanFactory.getClassBean("com.BusInrepairInfo");
			busInrepairInfoMap.put("id",selectMap.get("inrepairId"));
			busInrepairInfoMap =db.get(busInrepairInfoMap);
		 ...
		 */
		public IMap modifyBusElectricalReport(IMap in){
			IMap result = new DataMap();
			IMap userMap = (IMap) in.get("userMap");
			List busMaterialPlanList = (List) in.get("busMaterialPlan");
			for (int i = 0; i < busMaterialPlanList.size(); i++) {
			...
			LogBean logb=new LogBean(userMap,(String)in.get("id"), "com.BusElectrical","",remark, "0");
			LogRecordsService.saveOperationLog(logb,db);
		...
		public IMap saveMaterialConfirm(IMap in){
			...
			//获取基础组织编码
			IMap busElectricalMap = BeanFactory.getClassBean("com.BusElectrical");
			busElectricalMap.put("id", in.get("id"));
			busElectricalMap = db.get(busElectricalMap);
			String orgId= (String) busElectricalMap.get("orgId");
			String postCode="";
			postCode="车间材料员";
			condition.put("orgId", orgId);
			condition.put("postCode", postCode);
...
//				}
		...
		public IMap<String, Object> addBusTestRecord(IMap<String, Object> in) {
			...
			busTestRecord.put("busName","com.BusElectrical");
			//为创建数据赋值
		 ...
		 */
		public IMap modifyBusElectricalOpinionCheck(IMap in){
			IMap result = new DataMap();
			//试车检验结果
...
//				}
			...
			LogBean logb=new LogBean(userMap,(String)in.get("busId"), "com.BusElectrical","",remark, "0");
			LogRecordsService.saveOperationLog(logb,db);
			//工作流信息
			IMap wfmap = new DataMap();
			//wfmap.put("result", flag);// 判断是否受理
		 ...
		 * @date Jul 17, 2013 5:39:18 PM
		 */
		public IMap<String, Object> toConfirmBusElectrical(IMap<String, Object> in) {
			IMap<String, Object> result = new DataMap<String, Object>();// 输出map
			IMap selectMap = BeanFactory.getClassBean("com.BusElectrical");
			selectMap.put("id", in.get("id"));
			//业务表基本信息
		 ...
		 * @date Jul 19, 2013 9:38:03 AM
		 */
		public IMap saveBusElectricalConfirm(IMap in){
			IMap result = new DataMap();
			IMap userMap = (IMap) in.get("userMap");
			// 发起工作流
			IMap wfmap = new DataMap();
			...
			busElectricalMap.put("id", in.get("id"));
			busElectricalMap = db.get(busElectricalMap);
			busElectricalMap.put("factoryWhere", in.get("factoryWhere"));
			busElectricalMap.put("factoryDate", in.get("factoryDate"));
			
			
			String orgId="";
			String [] orgCodes =busElectricalMap.get("orgId").toString().replace(".",",").split(",");
			String postCode="";
			String rem="";
			if("1".equals(in.get("result"))){
				...
				factoryMap.put("busId", busElectricalMap.get("id"));
				factoryMap.put("busName", "com.BusElectrical");
				factoryMap.put("affirmType",1);//状态为1调度直接出厂
				factoryMap.put("orgId",userMap.get("orgId"));
				factoryMap.put("workCard",busElectricalMap.get("workCard"));
				factoryMap.put("equipmentName",busElectricalMap.get("equipmentName"));
				factoryMap.put("equipmentModel",busElectricalMap.get("equipmentModel"));
				...
				busRepairSettlementMap.put("workCard",busElectricalMap.get("workCard"));
				busRepairSettlementMap.put("mainCard",busElectricalMap.get("mainCard"));
				busRepairSettlementMap.put("assistCard",busElectricalMap.get("assistCard"));
				HelperDB.setCreate4isValid(HelperApp.getUserName(userMap), busRepairSettlementMap);
				db.insert(busRepairSettlementMap);
				
				busElectricalMap.put("repairState", "4");
				//将进修单信息改为出厂
				...
				inrepairMap.put("id", busElectricalMap.get("inrepairId"));
			...
			String actionId = "";
			String revenueType = (String)busElectricalMap.get("revenueType");
			...
			//log日志
			SimpleDateFormat dftow=new SimpleDateFormat("yyyy年MM月dd日 HH时mm分");
			String remark="监造："+userMap.get("name")+"在"+dftow.format(new Date())+rem;
			LogBean logb=new LogBean(userMap,(String)in.get("id"), "com.BusElectrical","",remark, "0");
			LogRecordsService.saveOperationLog(logb,db);
		 ...
		 * @date Jul 18, 2013 5:35:51 PM
		 */
		public IMap modifyBusElectricalComplete(IMap in){
			IMap result = new DataMap();
			IMap selectMap = BeanFactory.getClassBean("com.BusElectrical");
			selectMap.put("id", in.get("busId"));
			//进修单信息
	 ...
	 */
		...
		public IMap<String, Object> toaddNote(IMap<String, Object> in) {
			...
			if (!com.brick.util.Util.checkNull(flag)) {
				...
				IMap<String, Object> busMap = (IMap) in.get("busElectrical");
				...
				result.put("busElectricalMap", busMap);
			}
			return result;
		}
		/**
		...
		public IMap<String, Object> addNote(IMap<String, Object> in) {
			...
			busWorkNote.put("busName", "com.BusElectrical");
			Date date=new Date();	
			SimpleDateFormat df=new SimpleDateFormat("yyyy-MM-dd");
			String date_str=df.format(date);
			
			String busId = (String) busWorkNote.get("busId");
			IMap<String, Object> busMap = BeanFactory.getClassBean("com.BusElectrical");
			busMap.put("id", busId);
