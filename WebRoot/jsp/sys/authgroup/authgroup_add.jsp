...
<html>
	...
	<script type="text/javascript">
		...
		**/
			...
			if (confirm("请确定保存权限组信息吗？")) {
				document.forms[0].action = "${pageContext.request.contextPath }/api/authgroup/save";
...
<div class="row">
		<div class="span2"></div>
		<div class="span10">
			<h3 class="cBlack">权限组管理>>添加权限组</h3>
			<form method="post" action="" >
				...
				<div class="form-horizontal">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="span2" name="authGroupName" id="authGroupName"  size="30" check="1" placeholder="请填写权限组名称"><span class="help-inline">请填写权限组名称</span>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="remark">描述</label>
						<div class="controls">
							<textarea name="authGroupRemark" id="authGroupRemark" rows="3"></textarea><span class="help-block">请输入描述</span>
						</div>
					</div>
