...
<script type="text/javascript">
	function doSearch(){
		document.myform.action="${pageContext.request.contextPath}/api/report/importOutReport";
	    			...
	    			<input type="hidden" name="id" id="id"/>
    	 				<fieldset>
				            ...
				            <div class="span8">
				            	<p class="control-group">
				                <label for="">时间</label>
				                <input id="inDate" name="inDate" class="input-small" type="text"  value="${param.inDate }"
