	    			...
	    			<input type="hidden" name="id" id="id"/>
    	 				<fieldset>
				            ...
				            <div class="span8">
				            	<p class="control-group">
				                <label for="">时间</label>
				                <input id="searchDate" name="searchDate" class="input-small" type="text"  value="${param.searchDate}"
						            	onclick="SelectDate(this,'yyyy-MM',0,0)" onfocus="SelectDate(this,'yyyy-MM',0,0)" readonly="true" />
				              </p>
				            </div>
            				<div class="span10"> 
            					<a href="javascript:void(0);" class="btn btn-info" onclick="doSearch();"><i class="icon-search icon-white" ></i>导出报表</a> 
            				</div>	
          				</fieldset>
     				</form>     
  				</div>
