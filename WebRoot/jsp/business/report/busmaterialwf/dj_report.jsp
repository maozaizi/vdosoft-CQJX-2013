...
<script type="text/javascript">
	function goBack(){
		document.myform.action="${pageContext.request.contextPath}/api/report/toSearchMaterialDj";
		document.myform.submit();
	}
	function goOut(){
		document.myform.action="${pageContext.request.contextPath}/api/report/importMaterialDjReport";
		document.myform.submit();
	}
</script>
</head>
  		...
  		<div class="row-fluid">
  			<div class="span9">
      			<div class="page-header">
			        <h3>机修公司大件材料计划列表（<c:if test="${factory==1}">银川厂</c:if><c:if test="${factory==2}">庆阳厂</c:if>${searchDate }报表）</h3>
     			</div>
     		</div>
  			<div class="span12"> 
