...
<script type="text/javascript">
	function doSearch(){
		document.form.action="${pageContext.request.contextPath}/api/businrepairinfo/toManagerMoneyShare";
	...
	function toUpdate() {
		...
		document.form.action="${pageContext.request.contextPath}/api/businrepairinfo/toManagerMoneyShareUpdate";
		document.form.submit();
	}
</script>
</head>
			    	...
			    	<input type="hidden" name="url" id="url" value="${pageContext.request.contextPath}/api/businrepairinfo/toManagerMoneyShare"/>
    	 				...
    	 				<fieldset>
				        	...
				        	<div class="span10">
				       			...
				       			<a class="btn btn-primary" href="javascript:void(0)" onclick="toUpdate();"><i class="icon-edit icon-white"></i>&nbsp;分 摊</a> 
				       		</div>
				        </fieldset>
				        <!-- 搜索框 结束 end-->
		        	</form>
