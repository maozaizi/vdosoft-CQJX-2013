...
<script type="text/javascript">
	function toUpdate() {
		var store = document.getElementsByName("id");
		var checked = false;
		for (var i = 0; i < store.length; i++) {
			if (store[i].checked) {
				checked = true;
				document.getElementById("id").value=store[i].value;
			}
		}
		...
		document.myform.action="${pageContext.request.contextPath}/api/storeDetail/toUpdateStoreDetail";
	...
	function toAdd(){
		document.myform.action="${pageContext.request.contextPath}/api/storeDetail/toAddStoreDetail";
		document.myform.submit();
	}
</script>
</head>
