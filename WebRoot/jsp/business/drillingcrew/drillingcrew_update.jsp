...
<script type="text/javascript">
	   ...
	   function save(){
	   		document.myform.action="${pageContext.request.contextPath}/api/drillingcrew/updateCrew";
			$('#myform').submit();
	   }
...
<body>
	<div class="container-fluid" id="eqInfo">
	  	<div class="row-fluid">
	  		...
	  		<input type="hidden" name="id" id="id" value="${crewMap.id }"/>
		    <div class="span10">
		        	...
		        	<div class="row-fluid">
				         <div class="span6">
			        		<div class="control-group">
					          ...
					          <div class="controls">
					            <input id="teamName" name="teamName" class="input-medium" type="text" value="${crewMap.teamName }"   maxlength="40"  required  data-validation-required-message="必填项" />
  							  </div>
					        </div>
					        <div class="control-group">
					          <label class="control-label" for="teamCode">井队序号<span style="color:red"> *</span></label>
							  <div class="controls">
					             <input id="teamCode" name="teamCode" class="input-medium" type="text" value="${crewMap.teamCode }"   maxlength="40"  required  data-validation-required-message="必填项" />
  							  </div>	
					        </div>
					        <div class="control-group">
					          ...
					          <div class="controls">
						          <select id="projectDept" name="projectDept" style="width: 110px;">
										<c:forEach var="lev" items='${web:getDataItem("pro_dept")}'>
											<option value="${lev.dataItemCode }" <c:if test='${crewMap.projectDept==lev.dataItemCode}'>selected="selected"</c:if>>
												${lev.dataItemName }
											</option>
										</c:forEach>
									</select>
					        ...
					        <div class="control-group">
							  ...
							  <div class="controls">
					          	<div>
								    ...
								    <p><textarea rows="5" class="span12" id="remark" name="remark" onkeyup="textCounter(remark,tishi,100);">${crewMap.remark }</textarea></p>
						        </div>
  							  </div>	
					        </div>
			        	</div>
