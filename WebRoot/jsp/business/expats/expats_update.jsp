...
<html>
	<head>
		...
		<script type="text/javascript">
			function goBack(){
				window.location.href = "${pageContext.request.contextPath}/api/expats/getExpatsInfoList";
			}
			function save(){
				document.myform.action="${pageContext.request.contextPath}/api/expats/updateExpats";
		    ...
		    <div class="span9">
		            ...
		            <div class="row-fluid">
		            	<div class="span5">
		                    ...
		                    <dl class="dl-horizontal">
			                    <dt>完工日期：</dt>
			                    <dd>
			                     	<input id="backTime" name="backTime" class="input-medium" type="text"  value=""
		            ...
		            <div class="page-header">
			            <div id="accordion2" class="accordion">
					        ...
					        <div class="accordion-group">
					          <div class="accordion-heading"> <a href="#collapse${expatsDetail.id}" data-parent="#accordion2" data-toggle="collapse" class="accordion-toggle collapsed"> ${expatsDetail.deptName} </a> </div>
		        ...
		        <div class="form-actions">
					<p>
						...
						<c:if test="${flag ==1}">
							<a href="javaScript:void(0);" onclick="save();" class="btn btn-primary">确认完工</a>
						</c:if>
					</p>
				</div>
			</div>
