...
<script type="text/javascript">
	function doSearch(){
		document.myform.action="${pageContext.request.contextPath}/api/expats/getSupplyList";
		document.myform.submit();
	}
	function update(id){
		document.getElementById("id").value = id;
		document.myform.action="${pageContext.request.contextPath}/api/expats/toEditSupply";
		document.myform.submit();
	}
				            	...
				            	<c:forEach items="${page.resultList}" var="expats" varStatus="i">
				                	<tr>
					                     ...
					                     <td>
					                      ...
					                      <td>
				                     		<a class="btn btn-primary" href="#" onclick="update('${expats.id }');"><i class="icon-edit icon-white"></i>添加材料</a>
					                     </td>
				                 	</tr>
				                </c:forEach>
			               </c:if>
