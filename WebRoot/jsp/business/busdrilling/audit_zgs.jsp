...
<html>
	<head>
		...
		function audit(type){
		        $("#zgsResult").val(type);      
				document.myform.action="${pageContext.request.contextPath}/api/busdrilling/toZgsAudit";
		  ...
		  <form name="myform" action="" method="post">
		    <div class="span9">
		        ...
		        <div class="page-header">
						...
						<input type="hidden" name="tablename" value="com.BusDrilling"/>
			  ...
			  <div class="form-actions">
				<a onclick="creatPdf();" href="javascript:void(0);" class="btn">打印大件审批表</a><span style="color:red;">（请先打印大件审批表）</span>
			  </div>
			  <div class="form-actions">
