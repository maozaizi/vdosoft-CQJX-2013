	...
	<head>
		...
		<script type="text/javascript">
			function saveComplete(state){
				...
				document.myform.action="${pageContext.request.contextPath}/api/busdrilling/modifyBusDrillingComplete";
		        	...
		        	<div class="row-fluid">
		            	<div class="span5">
		                    ...
		                    <dl class="dl-horizontal">
		                        <dt>工卡号：</dt>
		                        <dd>
		                        <a href="${pageContext.request.contextPath}/api/busdrilling/toBusDrillingDetailsPage?id=${busInrepairInfoMap.Id}" target="_blank">${busDrillingMap.workCard}</a>
		                        </dd>
		                    </dl>
		                    <dl class="dl-horizontal">
		                        <dt>设备名称：</dt>
		                    ...
		                    <dl class="dl-horizontal">
		                       ...
		                       <div class="controls">
						            <select class="input-small" name="repairType" id="repairType">
						              <option  <c:if test="${busInrepairInfoMap.repairType==1}">selected</c:if> value="1">大修</option>
						              <option  <c:if test="${busInrepairInfoMap.repairType==2}">selected</c:if> value="2">中修</option>
									  <option  <c:if test="${busInrepairInfoMap.repairType==3}">selected</c:if> value="3">检修</option>
						            </select>
						          </div>
		                        </dd>
		                    </dl>
		        	...
		        	<div class="row-fluid">
		            	<div class="span5">
		                    <dl class="dl-horizontal">
					          <dt>检验结果：</dt>
					          <dd>
					            <p class="span18">${busDrillingMap.opinionChecker}</p>
					          </dd>
					        </dl>
	                    </dl>
	                </div>
