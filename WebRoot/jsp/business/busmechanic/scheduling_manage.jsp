...
<html>
	<head>
		...
		function save(res){
			...
			document.myform.action="${pageContext.request.contextPath}/api/busmechanic/doSchedulingManage";
		            ...
		            <div class="row-fluid">
		            	<div class="span5">
		                    <dl class="dl-horizontal">
		                        <dt>工卡号：</dt>
		                        <dd>
		                         <a href="${pageContext.request.contextPath}/api/busmechanic/toBusMechanicDetailsPage?id=${busMechanicMap.Id}" target="_blank">${busMechanicMap.workCard}</a>
		                        </dd>
		                    </dl>
		                    <dl class="dl-horizontal">
		                        <dt>设备名称：</dt>
