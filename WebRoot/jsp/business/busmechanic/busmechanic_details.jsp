		            ...
		            <div class="row-fluid">
		                ...
		                <dl class="dl-horizontal">
							...
							<dl class="dl-horizontal">
							 ...
							 <dl class="dl-horizontal">
		                        <dt>备注：</dt>
		                        <dd>${busMechanicMap.planRemark}</dd>
		                    </dl>
							<c:if test="${not empty busMechanicMap.opinionChecker}">
							<dl class="dl-horizontal">
								<dt>
									出厂检验意见：
								</dt>
								<dd>
									${busMechanicMap.opinionChecker}
								</dd>
							</dl>
							</c:if>
		                </div>
				            ...
				            <div class="accordion-inner">
				              <div class="row-fluid">
				                ...
				                <div class="span10">
				                  ...
				                  <c:if test="${not empty busMechanicMap.dispatchingRemark}">
									<dl class="dl-horizontal">
										<dt>
											车间派工意见：
										</dt>
										<dd>
											${busMechanicMap.dispatchingRemark}
										</dd>
									</dl>
									</c:if>
				                </div>
				...
				<h4>操作历史记录</h4>
		  		...
		  		<table class="table table-striped table-bordered"> 
                 	<tr>  
						...
						<th>操作动态<span style="float:right"><a href="#" onclick="openeq('${busMechanicMap.id}','${busInrepairInfoMap.id}');">更多>></a></span></th>
						</div>
					</tr>
				</table>
				  <table class="table table-striped table-bordered">
