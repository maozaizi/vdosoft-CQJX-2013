	...
	<head>
		...
		<script type="text/javascript">
			...
			function openMaterial(){
				window.open("${pageContext.request.contextPath}/api/busmechanic/toChooseMaterialInfo","","width=1250,height=700,scrollbars=yes");
			}
			function openMaterialHistory(){
				window.open("${pageContext.request.contextPath}/api/busmechanic/getMaterialListByWorkCard?busName=com.BusMechanic","","width=800,height=500,scrollbars=yes");
			}
			//删除行
			...
			function savePlan(){
				document.myform.action="${pageContext.request.contextPath}/api/busmechanic/saveBusMaterialPlan";
				if(checkForm()){
	...
	<div class="container-fluid">
 		<div class="row-fluid">
   			<div class="span9">
				...
				<input  type="hidden" name="busId" value="${busMechanicMap.id}"/>
     			...
     			<div class="page-header">
		        	...
		        	<div class="row-fluid">
		            	<div class="span5">
		                    ...
		                    <dl class="dl-horizontal">
		                        <dt>额定工时：</dt>
		                        <dd>${busMechanicMap.quotaHour}</dd>
		                    </dl>
		                     <dl class="dl-horizontal">
		                        <dt>机身编号：</dt>
		                ...
		                <div class="span5">
		                    ...
		                    <dl class="dl-horizontal">
		                        <dt>产值：</dt>
		                        <dd>${busMechanicMap.repairValue}</dd>
		                    </dl>
		                </div>
		                <div class="row-fluid">
		                <div class="span9">
					...
					<h4>领用材料申请</h4>
					 <div class="row-fluid">
					 	<div style="margin:5px 0 5px 5px;">
					 		...
					 		<a class="btn btn-medium" onclick="openMaterialHistory();" href="javascript:void(0)"><i class="icon-plus">
					 		</i>历史物料申请</a>
					 		材料计划编号：${busMechanicMap.assistCard}JH${num}
					 		<input class="" type="hidden" maxlength="20" name="planCode" id="planCode" value="${busMechanicMap.assistCard}JH${num}"/>
					 	</div>
							...
							<div class="row form-horizontal">
								<th>操作动态
									<span style="float:right">
										<a href="#" onclick="openeq('${busMechanicMap.id}','${busInrepairInfoMap.id}');">更多&gt;&gt;</a>
									</span>
								</th>
							</div>
						</tr>
