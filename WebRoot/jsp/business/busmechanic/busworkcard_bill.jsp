...
<html>
	<head>
		...
		function modifyTest(){
			...
			//	return false;
			//}
			document.myform.action="${pageContext.request.contextPath}/api/busmechanic/saveBusWorkCard";
	...
	<div class="container-fluid">
		  <div class="row-fluid">
			...
			<form name="myform" action="" class="form-horizontal">
				          ...
				          <div class="accordion-body in collapse" id="collapse${busWorkCard.id}">
				            ...
				            <div class="span6">
				              ...
				              <div class="control-group">
				               ...
				               <div class="controls">
				               <input id="orderEndDate${busWorkCard.id}" name="orderEndDate" class="input-medium" type="text"  value="<tag:date  value="${busMechanicMap.planEndTime}" />" readonly="true" /><div class='help-inline' id="SpanorderEndDate${busWorkCard.id}" style="color: red;"></div>
				             </div>
				               </div>
				            </div>
				            <div class="span6">
		        ...
		        <div class="page-header">
		            <input id="busId" name="busId" type="hidden" value="${busMechanicMap.id}"/>
