...
<script type="text/javascript">
		function submit(){
			if(checkForm()){
				document.form.action="${pageContext.request.contextPath}/api/busmechanic/saveOutStore";
...
<body>
	...
	<input type="hidden" name="busName" value="com.BusMechanic"/>
	<input type="hidden" name="workCard" value="${busMechanicMap.workCard}"/>
				            	...
				            	<c:forEach items="${materialList3}" var="material" varStatus="i">
				            		<tr>
				            			...
				            			<td>
				            				...
				            				<input type="hidden" name="realNum" value="${material.materialNum }"/>
				            			</td>
				            			<td>
				            				<input name="storeNum" class="input-mini" type="text" value="${material.ratifyNum}" check="1"/>
				            			</td>
				            		</tr>
				            	</c:forEach>
				            </c:if>
