	...
	<head>
		...
		<script type="text/javascript">
			...
			function openMaterialHistory(){
				window.open("${pageContext.request.contextPath}/api/busmechanic/getMaterialListByWorkCard?busName=com.MechTreatment","","width=800,height=500,scrollbars=yes");
			}
			//删除行
			...
			function savePlan(){
				document.myform.action="${pageContext.request.contextPath}/api/mechtreatment/saveBusMaterialPlan";
				if(checkForm()){
 		...
 		<div class="row-fluid">
   			<div class="span9">
				...
				<div class="page-header">
					<h4>领用材料申请</h4>
					 <div class="row-fluid">
					 	<div style="margin:5px 0 5px 5px;"><a class="btn btn-medium" onclick="openMaterial();" href="#"><i class="icon-plus"></i>选择材料</a>&nbsp;&nbsp;<a class="btn btn-medium" onclick="openMaterialHistory();" href="javascript:void(0)"><i class="icon-plus"></i>历史物料信息</a>
					 		材料计划编号：${mechTreatmentMap.assistCard}JH${num}
		  		...
		  		<div class="table">
			  	  <table class="table table-striped table-bordered"> 
	                 	<tr>  
							...
							<th>操作动态<span style="float:right"><a href="#" onclick="openeq('${mechTreatmentMap.Id}','${mechTreatmentMap.inrepairId}');">更多&gt;&gt;</a></span></th>
							</div>
						</tr>
				  </table>
				  <table class="table table-striped table-bordered">
