...
<script type="text/javascript">
	...
	function selectMaterial(materialClass,materialGroup,materialCode,materialDetail,unity,unitPrice){
		...
		typeTD.innerHTML='<select class="input-small" name="type"><option value="1">领用</option><option value="4">计划加领用</option><option value="2">加工</option><option value="3">修理</option></select>';
		//添加列:备注
	...
	<div class="container-fluid">
  		<div class="row-fluid">
    		<div class="span12">
    			<!-- iframe 材料选择列表 start -->
    			<div class="row-fluid">
					<iframe style="height:670px;width:100%;" frameborder="0" name="listFrame" id="listFrame" src="${pageContext.request.contextPath}/api/mechtreatment/chooseMaterialInfo?flag=1"></iframe>
				</div>
				<!-- iframe 材料选择列表 end -->
				<div class="row-fluid">
					<div class="span9">
