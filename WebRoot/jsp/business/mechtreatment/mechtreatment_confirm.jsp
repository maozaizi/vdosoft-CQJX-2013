...
<html>
	<head>
		...
		function save(res){
			...
			document.myform.action="${pageContext.request.contextPath}/api/mechtreatment/saveMechTreatmentConfirm";
		    ...
		    <div class="span9">
		        ...
		        <form action="" name="myform" id="myform">
		       	...
		       	<div class="form-actions">
				  	...
				  	<a class="btn btn-primary" href="javascript:void(0)" onclick="save(0);">出厂</a>
