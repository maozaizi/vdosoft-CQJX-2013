            ...
            $("#uploadify").uploadify({
                ...
                onUploadSuccess: function(file, data, response){
    				...
    				var params ="fileUrl="+fileUrl+"&docName="+filename+"&docSize="+filesize+"&docType="+fileext;
	   				...
	   				$.ajax({
					   type: "POST",
					   url: "${pageContext.request.contextPath}/ajaxapi/chargeoff/saveChargeoffDetailImport",
					   data: params,
					   dataType:"json",
...
<div class="row">
  <div class="span23 offset1">
    <h4 class="title-color">物料出账导入</h4>
    <form action="${pageContext.request.contextPath}/api/chargeoff/getChargeoffDetailList" name="myform">
    	<input name="attId" id="attId" type="hidden"/>
    </form>
  </div>
</div>
<div class="row">
