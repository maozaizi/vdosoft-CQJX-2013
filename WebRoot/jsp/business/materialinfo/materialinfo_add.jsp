...
<script type="text/javascript">
	function save(){
		document.myform.action="${pageContext.request.contextPath}/api/material/addMaterialInfo";
		$('#myform').submit();
	}
	function back(){
		        	...
		        	<div class="row-fluid" id="material">
						...
						<div class="span6">
							<div class="control-group">
					          ...
					          <div class="controls">
					          	<input id="materialDetail" name="materialDetail" class="input-medium" type="text"  required/>
					          </div>
					        </div>
					        <div class="control-group">
					          <label class="control-label" for="otherName">物料别名</label>
					          <div class="controls">
					          	<input id="otherName" name="otherName" class="input-medium" type="text"/>
					          </div>
					        </div>
					        <div class="control-group">
					        ...
					        <div class="control-group">
					          ...
					          <div class="controls">
					          	<input id="materialClass" name="materialClass" class="input-small" type="text" />
					          </div>
					        </div>
					        <div class="control-group">
						...
						<div class="span5">
							 <div class="control-group">
					          ...
					          <div class="controls">
					          	<input id="materialCode" name="materialCode" class="input-large" type="text" />
					          </div>
					         </div>
					        <div class="control-group">
					          <label class="control-label" for="unitPrice">单价</label>
					          <div class="controls">
					          	<input id="unitPrice" name="unitPrice" class="input-small" type="number"  required/>
					          </div>
					        </div>
					         <div class="control-group">
					          <label class="control-label" for="unity">单位</label>
					          <div class="controls">
					          	<input id="unity" name="unity" class="input-small" type="text" required />
					          </div>
					        </div>
					        <div class="control-group">
