		         ...
		         <div class="page-header">
		            ...
		            <div class="row-fluid">
		                ...
		                <dl class="dl-horizontal">
							...
							<c:if test="${not empty busElectricalMap.opinionChecker}">
							<dl class="dl-horizontal">
								<dt>
									出厂检验意见：
								</dt>
								<dd>
									${busElectricalMap.opinionChecker}
								</dd>
							</dl>
							</c:if>
		                </div>
				            ...
				            <div class="accordion-inner">
				              <div class="row-fluid">
				                ...
				                <div class="span10">
				                  ...
				                  <c:if test="${not empty busElectricalMap.dispatchingRemark}">
									<dl class="dl-horizontal">
										<dt>
											车间派工意见：
										</dt>
										<dd>
											${busElectricalMap.dispatchingRemark}
										</dd>
									</dl>
									</c:if>
				                </div>
