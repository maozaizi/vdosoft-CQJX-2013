...
<html>
	<head>
		...
		function audit(type){
	        $("#zrResult").val(type);      
			document.myform.action="${pageContext.request.contextPath}/api/buselectrical/toZrAudit";
	...
	<div class="container-fluid">
	   <div class="row-fluid">
		    <div class="span9">
	            ...
	            <div class="page-header">
		            ...
		            <div class="row-fluid">
		                ...
		                <dl class="dl-horizontal">
							...
							<dl class="dl-horizontal">
		                        <dt>备注：</dt>
		                        <dd>${busElectricalMap.planRemark}</dd>
		                    </dl>
		                </div>
		                </div>
		        ...
		        <div class="page-header">
				<input type="hidden" name="id" value="${busElectricalMap.id}"/>
