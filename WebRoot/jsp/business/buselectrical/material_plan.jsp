	...
	<head>
		...
		<script type="text/javascript">
			...
			function openMaterialHistory(){
				window.open("${pageContext.request.contextPath}/api/busmechanic/getMaterialListByWorkCard?busName=com.BusElectrical","","width=800,height=500,scrollbars=yes");
			}
			//删除行
			...
			function savePlan(){
				document.myform.action="${pageContext.request.contextPath}/api/buselectrical/saveBusMaterialPlan";
				if(checkForm()){
	...
	<div class="container-fluid">
 		<div class="row-fluid">
   			<div class="span11">
				...
				<input  type="hidden" name="busId" value="${busElectricalMap.id}"/>
				...
				<div class="page-header">
					<h4>领用材料申请</h4>
					 <div class="row-fluid">
					 	...
					 	材料计划编号：${busElectricalMap.assistCard}JH${num}
				 		<input class="" type="hidden" maxlength="20" name="planCode" id="planCode" value="${busElectricalMap.assistCard}JH${num}"/>
					 	</div>
			  	  ...
			  	  <table class="table table-striped table-bordered"> 
	                 	<tr>  
							<div class="row form-horizontal">
								<th>操作动态<span style="float:right"><a href="#" onclick="openeq('${busElectricalMap.id}','${busInrepairInfoMap.id}');">更多>></a></span></th>
							</div>
						</tr>
				  </table>
				  <table class="table table-striped table-bordered">
