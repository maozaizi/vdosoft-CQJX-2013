...
<html>
	<head>
		...
		function creatPdf(){
			document.forms[0].action = "${pageContext.request.contextPath}/api/busmechanic/printBigAccpet?contentType=pdf";
			document.forms[0].submit();
		}
		function audit(type){
		        $("#zgsResult").val(type);      
				document.myform.action="${pageContext.request.contextPath}/api/buselectrical/toZgsAudit";
		    ...
		    <div class="span9">
		        ...
		        <div class="page-header">
			 		<form name="myform" action="">
						...
						<input type="hidden" name="deptname" value="${companyName}${groupName}"/>
						<input type="hidden" name="tablename" value="com.BusElectrical"/>
						...
						<input type="hidden" name="type" id="type" value="zgs"/>
			            ...
			            <p><textarea onkeyup="textCounter(zgsRemark,oclable,500);" id="zgsRemark" name="zgsRemark" class="span12" rows="2"></textarea></p>
			  		</form>
			  </div>
			  <div class="form-actions">
				<a onclick="creatPdf();" href="javascript:void(0);" class="btn">打印大件审批表</a>
				<span style="color:red;">（请先打印大件审批表）</span>
			  </div>
			  <div class="form-actions">
