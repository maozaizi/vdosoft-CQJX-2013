...
<script type="text/javascript">
		function submit(){
			if(checkForm()){
				document.form.action="${pageContext.request.contextPath}/api/buselectrical/saveOutStore";
...
<body>
	...
	<input type="hidden" name="busName" value="com.BusElectrical"/>
	<input type="hidden" name="workCard" value="${busElectricalMap.workCard}"/>
