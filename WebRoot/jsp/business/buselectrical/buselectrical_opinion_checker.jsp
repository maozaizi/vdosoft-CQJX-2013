	...
	<head>
		...
		<script type="text/javascript">
			...
			function saveCheck(res){
				...
				document.myform.action="${pageContext.request.contextPath}/api/buselectrical/modifyBusElectricalOpinionCheck";
				$('#myform').submit();
			}
			function back(){
			        ...
			        <div class="page-header">
			        	...
			        	<div class="row-fluid">
			            	<div class="span5">
			                    ...
			                    <dl class="dl-horizontal">
			                        <dt>工卡号：</dt>
			                        <dd><a href="${pageContext.request.contextPath}/api/buselectrical/toBusElectricalDetailsPage?id=${busInrepairInfoMap.Id}" target="_blank">${busElectricalMap.workCard}</a>
			                        </dd>
			                    </dl>
			                    <dl class="dl-horizontal">
			                        <dt>设备名称：</dt>
				...
				<h4>操作历史记录</h4>
		  		...
		  		<table class="table table-striped table-bordered"> 
                 	<tr>  
						...
						<th>操作动态<span style="float:right"><a href="javascript:void(0);" onclick="openeq('${busElectricalMap.id}','${busInrepairInfoMap.id}');">更多>></a></span></th>
						</div>
					</tr>
				</table>
				  <table class="table table-striped table-bordered">
