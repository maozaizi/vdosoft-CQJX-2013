		...
		<div class="container-fluid" id="testDiv">
			<div class="row-fluid">
		    	<div class="span12">
	    			...
	    			<div class="page-header">
		        		<div class="row-fluid">
		        			<form class="form-horizontal" name="myform" id="myform" action="${pageContext.request.contextPath}/api/buselectrical/addNote">
						  	<input id="busId" name="busId" value="${busElectricalMap.id }" type="hidden"/>
		        			...
		        			<div class="span5">
								<div class="control-group">
									<label class="control-label" for="rotationalSpeed">施工卡号:</label>
								  	<div class="controls">
								  		${busElectricalMap.workCard }
								  		<input id="workCard" name="workCard" value="${busElectricalMap.workCard }" type="hidden"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="electricity">设备名称:</label>
									<div class="controls">
										${busElectricalMap.equipmentName }
										<input id="equipmentName" name="equipmentName" value="${busElectricalMap.equipmentName }" type="hidden"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="bearingTemp ">设备规格:</label>
									<div class="controls">
										${busElectricalMap.equipmentModel }
										<input id="equipmentModel" name="equipmentModel" value="${busElectricalMap.equipmentModel }" type="hidden"/>
									</div>
								</div>
		        			</div>
		        			<div class="span6">
		        				<div class="control-group">
									...
									<div class="controls">
								    	${busElectricalMap.teamNumber }
								    	<input id="deptFrom" name="deptFrom" value="${busElectricalMap.teamNumber }" type="hidden"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="voltage">开工日期:</label>
								    <div class="controls">
								    	<tag:date value="${busElectricalMap.startDate }"/>
								    	<input id="startDate" name="startDate" value="<tag:date value='${busElectricalMap.startDate }'/>" type="hidden"/>
									</div>
								</div>
		        			</div>
		        			<div class="span10">
