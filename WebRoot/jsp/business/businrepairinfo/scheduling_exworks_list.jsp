...
<script type="text/javascript">
	function doSearch(){
		document.myform.action="${pageContext.request.contextPath}/api/businrepairinfo/getFactoryList";
		document.myform.submit();
	}
	function update(id){
		document.myform.action="${pageContext.request.contextPath}/api/businrepairinfo/toSchedulingManage?id="+id;
		document.myform.submit();
	}
    		...
    		<div class="span9">
				...
				<div class="row-fluid">
    	 				<!-- <fieldset>
				            ...
				            <div class="span5">
				             <p class="control-group">
				                <label class="control-label" for="equipmentModel">规格型号</label>
