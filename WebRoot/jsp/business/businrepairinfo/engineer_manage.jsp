	...
	<head>
		...
		<script type="text/javascript">
			function saveComplete(){
				var factoryWhere =  document.getElementById("factoryWhere").value;
				var factoryDate =  document.getElementById("factoryDate").value;
				if(factoryWhere==""){
					alert("请填写出厂地点");
					return;
				}
				...
				document.myform.action="${pageContext.request.contextPath}/api/businrepairinfo/doEngineerManage";
	...
	<div class="container-fluid">
  		<div class="row-fluid">
			        	  ...
			        	  <div class="row-fluid">
				        	<span class="span5">
				        		<div class="control-group">
				        		 <dl class="dl-horizontal">
				                        <dt>使用单位：</dt>
				                        <dd><input id="factoryWhere" name="factoryWhere" value='${busInrepairInfoMap.factoryWhere}'  class="input-medium" type="text" maxlength="8"/></dd>
				                    </dl> 
						        </div>
				        	</span>
				        	<span class="span4">
            ...
            <div class="form-actions">
			  	...
			  	<a class="btn btn-primary" href="javascript:void(0)" onclick="saveComplete();">出厂</a>
			</div>    
	    </div>
    </div>    
</div>
