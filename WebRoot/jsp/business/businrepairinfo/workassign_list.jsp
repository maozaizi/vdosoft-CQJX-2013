...
<script type="text/javascript">
	function doSearch(){
		document.myform.action="${pageContext.request.contextPath}/api/businrepairinfo/getWorkAssignList";
	...
	function toCheckBusInrepairInfo() {
		...
		document.myform.action="${pageContext.request.contextPath}/api/businrepairinfo/toWorkAssign";
		document.myform.submit();
	}
				...
				<div class="row-fluid">
    	 				<fieldset>
            				...
            				<div class="span10">
            				 ...
            				 <a class="btn btn-primary" href="#" onclick="toCheckBusInrepairInfo();"><i class="icon-edit icon-white"></i>调 派</a>
            				 </div>
          				</fieldset>
