...
<html>
	<head>
		...
		function modifyTest(){
			...
			document.myform.action="${pageContext.request.contextPath}/api/busrivetweld/saveBusWorkCard";
	...
	<div class="container-fluid">
		  <div class="row-fluid">
			...
			<form name="myform" action="" class="form-horizontal">
				          ...
				          <div class="accordion-body in collapse" id="collapse${busWorkCard.id}">
				            ...
				            <div class="span6">
				              ...
				              <div class="control-group">
				               ...
				               <div class="controls">
				               <input id="orderEndDate${busWorkCard.id}" name="orderEndDate" class="input-medium" type="text"  value="<tag:date  value="${busRivetweldMap.planEndTime}" />" readonly="true" /><div class='help-inline' id="SpanorderEndDate${busWorkCard.id}" style="color: red;"></div>
				             </div>
				               </div>
				            </div>
				            <div class="span6">
				            ...
				            <div class="row-fluid">
				               <div class="span10">
        						...
        						<div class="row-fluid">
				            	<div class="span10">
	            				<!-- <span style="float:right"><a id="Edu_hidden${busWorkCard.id}" style="display: inline;" class="btn btn-primary" onclick="save('${busWorkCard.id}');">保存</a></span> -->
        						</div>
        						</div>
				            </div>
		        ...
		        <div class="page-header">
		            <input id="busId" name="busId" type="hidden" value="${busRivetweldMap.id}"/>
