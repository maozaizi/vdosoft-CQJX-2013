	...
	<head>
		...
		<script type="text/javascript">
			...
			function saveCheck(res){
				...
				document.myform.action="${pageContext.request.contextPath}/api/busrivetweld/modifyBusRivetweldOpinionCheck";
				$('#myform').submit();
			}
			function back(){
    	 	  	...
    	 	  	<form name="myform" action="" id="myform" class="form-horizontal">
			        ...
			        <div class="page-header">
			        	 <h4 class="title-color">检验结果</h4>
			              ...
			              <p><textarea rows="2" class="span12" name="opinionChecker" id="opinionChecker" check="1" onkeyup="textCounter(opinionChecker,oclable,100);"></textarea>
		        	 </div>
       	 	   </form>
			        <!-- 检验结果 end -->
