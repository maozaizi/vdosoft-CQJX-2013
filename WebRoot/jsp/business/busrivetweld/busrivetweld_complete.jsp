	...
	<head>
		...
		<script type="text/javascript">
			function saveComplete(state){
				...
				document.myform.action="${pageContext.request.contextPath}/api/busrivetweld/modifyBusRivetweldComplete";
		        ...
		        <div class="page-header">
		        	...
		        	<div class="row-fluid">
		            	<div class="span5">
		                    <dl class="dl-horizontal">
					          <dt>检验结果：</dt>
					          <dd>
					            <p class="span18">${busRivetweldMap.opinionChecker}</p>
					          </dd>
					        </dl>
	                    </dl>
	                </div>
	                ...
	                <form action="" name="myform">
						...
						<input type="hidden" name="instanceId" id="instanceId" value="${instanceId }"/>
					  	<input name="busId" id="busId" value="${busRivetweldMap.id }" type="hidden" />
