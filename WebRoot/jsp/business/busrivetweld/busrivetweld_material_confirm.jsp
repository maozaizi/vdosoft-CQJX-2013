...
<script type="text/javascript">
	function save(){
		document.myform.action="${pageContext.request.contextPath}/api/busrivetweld/saveMaterialConfirm";
			      		...
			      		<table class="table table-striped table-bordered">
		          			 ...
		          			 <form action="" name="myform" id="myform">
						           <c:if test="${empty busMaterialPlanList}">
						            <tr>
						            	<th colspan="7" style="text-align: center;"><font color='red'>暂无数据！</font></th>
						            </tr>	
						           </c:if>
