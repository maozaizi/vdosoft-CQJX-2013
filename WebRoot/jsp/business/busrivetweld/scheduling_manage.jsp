...
<html>
	<head>
		...
		function save(res){
			...
			document.myform.action="${pageContext.request.contextPath}/api/busrivetweld/doSchedulingManage";
		            ...
		            <div class="row-fluid">
		            	<div class="span5">
		                    <dl class="dl-horizontal">
		                        <dt>工卡号：</dt>
		                        <dd>
		                         <a href="${pageContext.request.contextPath}/api/busrivetweld/toBusRivetweldDetailsPage?id=${busRivetweldMap.Id}" target="_blank">${busRivetweldMap.workCard}</a>
		                        </dd>
		                    </dl>
		                    <dl class="dl-horizontal">
		                        <dt>设备名称：</dt>
			        	  ...
			        	  <div class="row-fluid">
				        	<span class="span5">
				        		<div class="control-group">
				        		 <dl class="dl-horizontal">
				                        <dt>出厂地点：</dt>
				                        <dd><input id="factoryWhere" name="factoryWhere" value="${busRivetweldMap.factoryWhere}" class="input-medium" type="text" maxlength="8"/></dd>
				                    </dl> 
						        </div>
				        	</span>
				        	<span class="span4">
				        		<div class="control-group">
						         	<dl class="dl-horizontal">
				                        <dt>出厂时间：</dt>
				                        <dd><input id="factoryDate" name="factoryDate" value="<tag:date  value='${busRivetweldMap.factoryDate}' />" class="input-medium" type="text" required
