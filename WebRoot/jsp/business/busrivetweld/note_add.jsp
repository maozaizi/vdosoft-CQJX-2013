	    			...
	    			<div class="page-header">
		        		<div class="row-fluid">
		        			<form class="form-horizontal" name="myform" id="myform" action="${pageContext.request.contextPath}/api/busmechanic/addNote">
						  	<input id="busId" name="busId" value="${busRivetweldMap.id }" type="hidden"/>
		        			...
		        			<div class="span5">
								<div class="control-group">
									<label class="control-label" for="rotationalSpeed">施工卡号:</label>
								  	<div class="controls">
								  		${busRivetweldMap.workCard }
								  		<input id="workCard" name="workCard" value="${busRivetweldMap.workCard }" type="hidden"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="electricity">设备名称:</label>
									<div class="controls">
										${busRivetweldMap.equipmentName }
										<input id="equipmentName" name="equipmentName" value="${busRivetweldMap.equipmentName }" type="hidden"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="bearingTemp ">设备规格:</label>
									<div class="controls">
										${busRivetweldMap.equipmentModel }
										<input id="equipmentModel" name="equipmentModel" value="${busRivetweldMap.equipmentModel }" type="hidden"/>
									</div>
								</div>
		        			</div>
		        			<div class="span6">
		        				<div class="control-group">
									...
									<div class="controls">
								    	${busRivetweldMap.teamNumber }
								    	<input id="deptFrom" name="deptFrom" value="${busRivetweldMap.teamNumber }" type="hidden"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="voltage">开工日期:</label>
								    <div class="controls">
								    	<tag:date value="${busRivetweldMap.startDate }"/>
								    	<input id="startDate" name="startDate" value="<tag:date value='${busRivetweldMap.startDate }'/>" type="hidden"/>
									</div>
								</div>
		        			</div>
		        			<div class="span10">
