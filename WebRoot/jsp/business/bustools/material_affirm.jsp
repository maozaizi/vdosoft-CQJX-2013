...
<link href="${pageContext.request.contextPath}/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
		...
		function submit(type){
		        $("#affirmtype").val(type);
				document.form.action="${pageContext.request.contextPath}/api/busdrilling/doMaterialAffirm";
		        	...
		        	<div class="row-fluid">
		            	<div class="span5">
		                    <dl class="dl-horizontal">
		                        <dt>工卡号：</dt>
		                        <dd><a href="${pageContext.request.contextPath}/api/bustoolswf/toBustoolswfDetail?id=${busDrillingMap.Id}" target="_blank">${busDrillingMap.workCard}</a>
		                        </dd>
		                    </dl>
		                    <dl class="dl-horizontal">
		                        <dt>设备名称：</dt>
