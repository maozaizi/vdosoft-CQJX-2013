...
<html>
	<head>
		...
		function creatPdf(){
			document.forms[0].action = "${pageContext.request.contextPath}/api/bustoolswf/printBigAccpet?contentType=pdf";
			document.forms[0].submit();
		}
		
		function audit(type){
		        $("#zgsResult").val(type);      
				document.myform.action="${pageContext.request.contextPath}/api/bustoolswf/savezgsAudit";
		...
		function changePrice(index){
			...
			if(ratifyNum[index].value!=null&&estimatePrices[index].value!=""){
		    ...
		    <div class="span9">
		        ...
		        <div class="page-header">
			            	...
			            	<table class="table table-striped table-bordered" id="materialPlanTable">
			                    ...
			                    <tbody>
			                        ...
			                        <c:if test="${not empty busMaterialPlanList}">
			                            ...
			                            <c:if test="${busMaterialPlan.estimatePrice>10000}">
			                                <tr>
			        ...
			        <div class="page-header">
							...
							<input type="hidden" name="tablename" value="com.BusToolswf"/>
