...
<html>
	<head>
		...
		function audit(type){
	        $("#cqResult").val(type);      
			document.myform.action="${pageContext.request.contextPath}/api/busplanwf/toCqAudit";
		...
		<div class="row-fluid">
			<div class="span9">
			  <div class="page-header">
				...
				<input type="hidden" name="cqResult" id="cqResult" value=""/>
				...
				<input type="hidden" name="type" id="type" value="cq"/>
		        ...
		        <h4>审批意见</h4>
			            ...
			            <p><textarea onkeyup="textCounter(cqRemark,oclable,500);" id="cqRemark" name="cqRemark" class="span12" rows="2"></textarea></p>
			  </div>
			  </form>
