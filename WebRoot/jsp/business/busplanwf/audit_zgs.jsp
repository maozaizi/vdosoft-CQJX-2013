		    ...
		    <div class="span9">
		       ...
		       <form name="myform" action="">
		        <div class="page-header">
		        	...
		        	<c:if test="${fn:length(busMaterialPlanWfList)<11}">
		        	<div class="row-fluid">
		        	</c:if>
		        	<c:if test="${fn:length(busMaterialPlanWfList)>10}">
		        ...
		        <div class="page-header">
						<input type="hidden" name="id" value="${busPlanInfoWfMap.id}"/>
						<input type="hidden" name="zgsResult" id="zgsResult" value=""/>
						<input type="hidden" name="busid" value="${busPlanInfoWfMap.id}"/>
						<input type="hidden" name="deptname" value="${companyName}${groupName}"/>
						<input type="hidden" name="tablename" value="com.BusPlanInfoWf"/>
