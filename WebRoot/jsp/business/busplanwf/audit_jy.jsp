...
<html>
	<head>
		...
		function audit(type){
	        $("#jyResult").val(type);      
			document.myform.action="${pageContext.request.contextPath}/api/busplanwf/toJyAudit";
	   ...
	   <div class="row-fluid">
		    <div class="span9">
		       ...
		       <form name="myform" action="">
				...
				<input type="hidden" name="jyResult" id="jyResult" value=""/>
				...
				<input type="hidden" name="type" id="type" value="jy"/>
		        ...
		        <h4>审批意见</h4>
			            ...
			            <p><textarea onkeyup="textCounter(jyRemark,oclable,500);" id="jyRemark" name="jyRemark" class="span12" rows="2"></textarea></p>
			  </div>
			  </form>
