...
<html>
	<head>
		...
		function audit(type){
		  $("#jlResult").val(type);
		  document.myform.action="${pageContext.request.contextPath}/api/busplanwf/toJlAudit";
		  if(type!="0"){
		  if($("#sk").val()=="1"){
		...
		function openeq(id){
		window.open("${pageContext.request.contextPath}/api/logRecords/getLogRecordsList?id="+id);
		}
		...
		<div class="row-fluid">
			<div class="span9">
		      ...
		      <div class="page-header">
				...
				<input type="hidden" name="jlResult" id="jlResult" value=""/>
				<input type="hidden" name="type" id="type" value="jl"/>
				...
				<input type="hidden" name="nodeId" id="nodeId" value="${nodeId}"/>
			  	<input id="sk" name="sk" type="hidden" value="${sk}"/>
		       ...
		       <h4>审批意见</h4>
			            ...
			            <p><textarea onkeyup="textCounter(jlRemark,oclable,500);" id="jlRemark" name="jlRemark" class="span12" rows="2"></textarea></p>
			  </div>
			  </form>
