	...
	function saveSelect(){
		//材料计划页面 选择材料table
	   	...
	   	for (var i = 1; i<selectTable.rows.length; i++) {
			...
			newTR.insertCell(7).innerHTML='<input id="remark" name="remark" class="input-mini" value="'+remark[i-1].value+'" type="text"/>';
			newTR.insertCell(8).innerHTML='<a href="javascript:void(0);" onclick="delRow('+(tableLength+i-1)+')">删除</a>';
		}
	...
	<div class="container-fluid">
  		<div class="row-fluid">
    		<div class="span12">
    			<!-- iframe 材料选择列表 start -->
    			<div class="row-fluid">
					<iframe style="height:670px;width:100%;" frameborder="0" name="listFrame" id="listFrame" src="${pageContext.request.contextPath}/api/busdrilling/chooseMaterialInfo?flag=1"></iframe>
				</div>
				<!-- iframe 材料选择列表 end -->
				<div class="row-fluid">
					<div class="span9">
