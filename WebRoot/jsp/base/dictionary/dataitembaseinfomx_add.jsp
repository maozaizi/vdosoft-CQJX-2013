		...
		function save(){
			var divId = document.getElementById("divId"); 
        	 var result = checkText(divId);
       			...
       			document.forms[0].action="${pageContext.request.contextPath}/api/dictionary/addMx";
			...
			<form id="addForm" method="post" action="" >
				...
				<div class="form-horizontal">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="span2" name="dataItemName" size="30"   maxlength="100" check="1" placeholder="请填写名称"><span class="help-inline">请填写名称</span>
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							<textarea name="memo"  rows="3"></textarea><span class="help-block">请输入描述</span>
						</div>
					</div>
