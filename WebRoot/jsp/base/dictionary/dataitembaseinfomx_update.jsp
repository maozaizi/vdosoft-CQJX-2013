		...
		function save(){
			var divId = document.getElementById("divId"); 
        	 var result = checkText(divId);
       			...
       			document.forms[0].action="${pageContext.request.contextPath}/api/dictionary/modifyMx";
	...
	<div class="row" id="divId">
		...
		<div class="span10">
			...
			<form id="addForm" method="post" action="" >
				...
				<input type="hidden" name="dataItemId" id="dataItemId" value="${dataItemBaseInfo.dataItemId}"/>
