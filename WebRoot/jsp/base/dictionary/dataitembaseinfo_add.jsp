			...
			var divId = document.getElementById("divId"); 
        	 var result = checkText(divId);
	   		if(result != ""){
       			...
       			document.forms[0].action="${pageContext.request.contextPath}/api/dictionary/add";
			...
			<form id="addForm" method="post" action="" >
				...
				<div class="form-horizontal">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="span2" name="dataItemName"   maxlength="100" check="1" placeholder="请填写名称"><span class="help-inline">请填写名称</span>
						</div>
					</div>
					<!-- 
					<div class="control-group">
